...
'''
Program that writes the most recent 3,000 tweets to a csv file that will be
used as input data later.

This code is based off of the following git repository:
